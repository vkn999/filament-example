...
class CreatePage extends CreateRecord
{
    ...
    /**
     * Устанавливает превью страницы из элемента медиагалереи.
    ...
    public function setPreviewFromMedia(int $mediaId, ?string $altOverride = null): void
    {
        ...
        // Используем доменную модель Page для повторного использования логики
        $page = new \App\Models\Page;
        $page->setPreviewFromMedia($media, $altOverride);

        // Аккуратно обновляем только поля превью
        $state = $this->form->getState();
        $state['image_preview'] = $page->image_preview;
        $state['image_preview_sizes'] = $page->image_preview_sizes;
        $state['image_preview_alt'] = $page->image_preview_alt;
        $state['preview_media_id'] = $page->preview_media_id;
